...
<provides>
Vector memory iron rules with cookbook delegation. JSON-only in strict/paranoid.
...
<provides>
Vector task iron rules with cookbook delegation. JSON-only in strict/paranoid.
...
# Cookbook first
strict/paranoid: pull gates-rules BEFORE memory operations.
...
# Cookbook first
strict/paranoid: pull gates-rules BEFORE task operations.
