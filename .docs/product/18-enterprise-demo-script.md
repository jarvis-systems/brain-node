...
Expected: `valid:82, invalid:0, warnings:0`. Proves: all 82 docs have YAML front matter, no broken references.
...
Expected: `264 tests, 620 assertions, 0 failures`. Proves: full test coverage, deterministic compilation, merger invariants, node integrity, MCP schema validation.
...
| Docs validate | 82 documents with consistent metadata |
