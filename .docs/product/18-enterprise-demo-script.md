...
Expected: `valid:87, invalid:0, warnings:0`. Proves: all 87 docs have YAML front matter, no broken references.
...
| Docs validate | 87 documents with consistent metadata |
