...
Expected: `valid:81, invalid:0, warnings:0`. Proves: all 81 docs have YAML front matter, no broken references.
...
| Docs validate | 81 documents with consistent metadata |
