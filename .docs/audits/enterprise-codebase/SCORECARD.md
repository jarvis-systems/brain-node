...
| 6 | Testability | 3 | 3 | 3 | 3.0 | Core: 264 tests, 620 assertions (19 files); CLI: 444 tests, 853 assertions (31 files); Node: 13 tests via NodeIntegrityTest; PHPStan L2 across core+CLI (0 errors); **Roadmap 15.4**: 4 batches of CLI test expansion (docs services, traits, make commands, make:mcp deep) |
