...
| 6 | Testability | 3 | 3 | 3 | 3.0 | Core: 284 tests, 653 assertions (19 files); CLI: 721 tests, 1630 assertions (31 files); Node: 13 tests via NodeIntegrityTest; PHPStan L4 (core) + L2 (cli) (0 errors); **Roadmap 15.4**: 4 batches of CLI test expansion (docs services, traits, make commands, make:mcp deep) |
...
- ~~No static analysis tool~~ **FIXED** — phpstan 2.x installed in core (level 4, documented suppressions + constants bootstrap), `composer analyse` in CI
...
- `#[Meta('model')]` added to then-active agents across explore, documentation, web research, vector, orchestration, prompt, and script surfaces
