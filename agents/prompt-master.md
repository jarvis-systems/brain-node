...
<phase name="verify">Read('/commands/{name}.md') → validate output</phase>
</example>
</guideline>
...
<phase name="compile">Bash('brain compile')</phase>
<phase name="verify">Read('QWEN.md') → validate</phase>
</example>
</guideline>
...
<example key="discover">Glob('/agents/*.md') → discover agents</example>
