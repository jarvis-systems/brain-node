...
- **Testing:** MergerTest, XmlBuilderTest, TomlBuilderTest, CompilationOutputTest, BuilderDeterminismTest, MergerInvariantsTest, CompileIdempotencyTest, NodeIntegrityTest, McpSchemaValidatorTest, RuntimeTest, ToolFormatTest, VarExporterDegradationTest, MDTest, CoreTest, VarChainTest, BlueprintTest, SnapshotTest
...
# Important
Цей проект зараз має бути відшліфований до ідеалу. Всі його інструкції, всі його можливості мають бути повністю закінчені, виконані. Ідея має бути повністю покрита. І код має бути повністю готовий до Enterprise. Щоб це був Ferrari. Академічного рівня. Потім цей проект буде братися як еталон для того, щоб робити його на go. Але ми не пишемо плани в документах, ми пишемо все в коді. Відточуємо спочатку цей прототип до ідеалу, а потім агент Рой буде писати і копіювати його на Go. Але ідеал, маніфест має бути цей проєкт.
Ти маєш бути налаштований на повний ентерпрайз-підхід, де ми не заміняємо щось, щоб аби працювало, де ми виконуємо все до кінця в нашому продукті, якщо в ньому чогось не вистачає для того, щоб він був максимально якісного рівня. В нас не має бути ситуації, коли би ти вирішив не використовувати, наприклад, AI-тулзу нашу і вибрав замість цього використовувати claude напряму. 
