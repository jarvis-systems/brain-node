...
## Examples
 ...
 - **verify**: Read('.gemini/commands/{name}.md') → validate output
</guideline>
...
## Examples
 ...
 - **compile**: Bash('brain compile')
 - **verify**: Read('GEMINI.md') → validate
</guideline>
...
## Examples
 - IF(novel domain OR complex reasoning OR low confidence) → THEN → [WebSearch(prompt engineering {domain} 2025)] → ELSE → [proceed with known patterns] → END-IF
</guideline>
...
## Examples
 - Glob('.gemini/agents/*.md') → discover agents
