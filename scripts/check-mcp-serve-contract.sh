...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
...
echo '{"jsonrpc":"2.0","id":2,"method":"tools/list","params":{}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"docs_search","arguments":{"query":"test","limit":1}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"diagnose","arguments":{}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
if ! jq -e '.result.content[0].type == "text"' /tmp/mcp_out.json >/dev/null 2>&1; then
...
echo '{"jsonrpc":"2.0","id":5,"method":"tools/call","params":{"name":"diagnose","arguments":{}}}' | BRAIN_DISABLE_MCP=true BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":99,"method":"test"' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":6,"method":"tools/call","params":{"name":"nonexistent.tool","arguments":{}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
# docs_search
echo '{"jsonrpc":"2.0","id":7,"method":"tools/call","params":{"name":"docs_search","arguments":{"query":"test","limit":1}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1

# diagnose
echo '{"jsonrpc":"2.0","id":8,"method":"tools/call","params":{"name":"diagnose","arguments":{}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1

# list_masters
echo '{"jsonrpc":"2.0","id":9,"method":"tools/call","params":{"name":"list_masters","arguments":{}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":10,"method":"tools/call","params":{"name":"docs_search","arguments":{"validate":true}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
if ! jq -e '.result.content[0].type == "text"' /tmp/mcp_out.json >/dev/null 2>&1; then
...
echo '{"jsonrpc":"2.0","id":11,"method":"tools/call","params":{"name":"docs_search","arguments":{"cache-health":true}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
if ! jq -e '.result.content[0].type == "text"' /tmp/mcp_out.json >/dev/null 2>&1; then
...
echo '{"jsonrpc":"2.0","id":12,"method":"tools/call","params":{"name":"list_masters","arguments":{}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
if ! jq -e '.result.content[0].type == "text"' /tmp/mcp_out.json >/dev/null 2>&1; then
...
echo '{"jsonrpc":"2.0","id":13}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":14,"method":"unknown_method","params":{}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":15,"method":"tools/call","params":{"name":"diagnose","arguments":{"invalid_option":true}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
...
echo '{"jsonrpc":"2.0","id":16,"method":"tools/call","params":{"name":"list_masters","arguments":{"agent":"claude"}}}' | BRAIN_AGENT_ID=claude brain_cli mcp:serve 1>/tmp/mcp_out.json 2>/tmp/mcp_err.txt
check_stderr_empty /tmp/mcp_err.txt || exit 1
if ! jq -e '.error.data.reason == "INVALID_INPUT"' /tmp/mcp_out.json >/dev/null 2>&1; then
