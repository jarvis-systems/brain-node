...
log "${BOLD}[1/34] PHP syntax check${NC}"
...
log "${BOLD}[2/34] PHPUnit tests${NC}"
...
log "${BOLD}[3/34] Silent catch blocks${NC}"
...
log "${BOLD}[4/34] Debug artifacts${NC}"
...
log "${BOLD}[5/34] TODO/FIXME markers${NC}"
...
log "${BOLD}[6/34] Unsafe patterns (eval/shell_exec/die/exit)${NC}"
...
log "${BOLD}[7/34] Shell script safety headers${NC}"
...
log "${BOLD}[8/34] No-op escape method detection${NC}"
...
log "${BOLD}[9/34] Late static binding in traits${NC}"
...
log "${BOLD}[10/34] Known typos in codebase${NC}"
...
log "${BOLD}[11/34] Dev dependencies in production require${NC}"
...
log "${BOLD}[12/34] PHPStan static analysis${NC}"
...
log "${BOLD}[13/34] Missing declare(strict_types=1)${NC}"
...
log "${BOLD}[14/34] Secret patterns in tracked files${NC}"
...
log "${BOLD}[15/34] Hardcoded user paths in tracked source files${NC}"
...
log "${BOLD}[16/34] Degradation observability in catch blocks${NC}"
...
log "${BOLD}[17/34] Version consistency${NC}"
...
log "${BOLD}[18/34] MCP schema bypass enforcement${NC}"
...
log "${BOLD}[19/34] Compile clean-worktree gate${NC}"
...
log "${BOLD}[20/34] Agent schema enabled set${NC}"
...
log "${BOLD}[21/34] MCP tool policy contract${NC}"
...
log "${BOLD}[22/34] Self-hosting workspace hygiene${NC}"
...
log "${BOLD}[23/34] Test Mode Contract enforcement${NC}"
...
log "${BOLD}[24/34] MCP policy inspector output contract${NC}"
...
log "${BOLD}[25/34] MCP allowlist contract${NC}"
...
log "${BOLD}[26/34] mcp:docs-search contract${NC}"
...
log "${BOLD}[27/34] mcp:diagnose contract${NC}"
...
log "${BOLD}[28/34] Secret reference hygiene${NC}"
...
log "${BOLD}[29/34] MCP registry contract${NC}"
...
log "${BOLD}[30/34] MCP compile consistency${NC}"
...
log "${BOLD}[31/34] MCP registry validation${NC}"
...
log "${BOLD}[32/34] MCP call bridge v1${NC}"
...
log "${BOLD}[33/34] MCP external tools policy${NC}"
...
log "${BOLD}[34/34] MCP external tools call gating${NC}"
