...
log "${BOLD}[1/32] PHP syntax check${NC}"
...
log "${BOLD}[2/32] PHPUnit tests${NC}"
...
log "${BOLD}[3/32] Silent catch blocks${NC}"
...
log "${BOLD}[4/32] Debug artifacts${NC}"
...
log "${BOLD}[5/32] TODO/FIXME markers${NC}"
...
log "${BOLD}[6/32] Unsafe patterns (eval/shell_exec/die/exit)${NC}"
...
log "${BOLD}[7/32] Shell script safety headers${NC}"
...
log "${BOLD}[8/32] No-op escape method detection${NC}"
...
log "${BOLD}[9/32] Late static binding in traits${NC}"
...
log "${BOLD}[10/32] Known typos in codebase${NC}"
...
log "${BOLD}[11/32] Dev dependencies in production require${NC}"
...
log "${BOLD}[12/32] PHPStan static analysis${NC}"
...
log "${BOLD}[13/32] Missing declare(strict_types=1)${NC}"
...
log "${BOLD}[14/32] Secret patterns in tracked files${NC}"
...
log "${BOLD}[15/32] Hardcoded user paths in tracked source files${NC}"
...
log "${BOLD}[16/32] Degradation observability in catch blocks${NC}"
...
log "${BOLD}[17/32] Version consistency${NC}"
...
log "${BOLD}[18/32] MCP schema bypass enforcement${NC}"
...
log "${BOLD}[19/32] Compile clean-worktree gate${NC}"
...
log "${BOLD}[20/32] Agent schema enabled set${NC}"
...
log "${BOLD}[21/32] MCP tool policy contract${NC}"
...
log "${BOLD}[22/32] Self-hosting workspace hygiene${NC}"
...
log "${BOLD}[23/32] Test Mode Contract enforcement${NC}"
...
log "${BOLD}[24/32] MCP policy inspector output contract${NC}"
...
log "${BOLD}[25/32] MCP allowlist contract${NC}"
...
log "${BOLD}[26/32] mcp:docs-search contract${NC}"
...
log "${BOLD}[27/32] mcp:diagnose contract${NC}"
...
log "${BOLD}[28/32] Secret reference hygiene${NC}"
...
log "${BOLD}[29/32] MCP registry contract${NC}"
...
log "${BOLD}[30/32] MCP compile consistency${NC}"
...
log "${BOLD}[31/32] MCP registry validation${NC}"
...
log "${BOLD}[32/32] MCP call bridge v1${NC}"
